...
function createPopupContent(properties, attribute){
    // Add country to popupContent string
    var popupContent = '<p><b>Country:</b> ' + properties.country + '</p>';
    // Add year and percentage data to popupContent
    popupContent += '</p><p><b>Renewable Percentage of Electricity Generation in ' + attribute + ':</b> ' + properties[attribute] + '%</p>';
    return popupContent;
};
